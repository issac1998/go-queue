...
func handleConnection(conn net.Conn) {
	...
	for {
		...
		case protocol.JoinGroupRequestType:
			protocol.HandleJoinGroupRequest(conn, manager, clusterManager)
		case protocol.LeaveGroupRequestType:
			protocol.HandleLeaveGroupRequest(conn, manager, clusterManager)
		case protocol.HeartbeatRequestType:
			protocol.HandleHeartbeatRequest(conn, manager, clusterManager)
		case protocol.CommitOffsetRequestType:
			protocol.HandleCommitOffsetRequest(conn, manager, clusterManager)
		case protocol.FetchOffsetRequestType:
			protocol.HandleFetchOffsetRequest(conn, manager, clusterManager)
