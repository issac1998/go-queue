...
func TestPebbleHalfMessageStorage(t *testing.T) {
	...
	t.Run("Store and Get", func(t *testing.T) {
		// 创建存储实例
		storage, err := NewPebbleHalfMessageStorage(tempDir + "/store_get")
		require.NoError(t, err)
		defer storage.Close()
	...
	t.Run("Delete", func(t *testing.T) {
		// 创建存储实例
		storage, err := NewPebbleHalfMessageStorage(tempDir + "/delete")
		require.NoError(t, err)
		defer storage.Close()
	...
	t.Run("GetExpiredMessages", func(t *testing.T) {
		// 创建存储实例
		storage, err := NewPebbleHalfMessageStorage(tempDir + "/expired")
		require.NoError(t, err)
		defer storage.Close()
	...
	t.Run("CleanupExpired", func(t *testing.T) {
		// 创建存储实例
		storage, err := NewPebbleHalfMessageStorage(tempDir + "/cleanup")
		require.NoError(t, err)
		defer storage.Close()
