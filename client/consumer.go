...
// FetchFrom is a convenience method for fetching from a specific offset
...
// SubscribePartition subscribes to a specific partition with a message handler

// parseRangeMessages parses messages for a single range in batch fetch response
func (c *Consumer) parseRangeMessages(topic string, partition int32, startOffset int64, messageCount int32, buf *bytes.Reader) ([]Message, error) {
